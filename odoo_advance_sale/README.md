# Advance Sale and Delivery — Odoo 17
...
This folder contains the Odoo 17 port. Add its parent directory to that
version's addons path, restart Odoo, refresh Apps and install Advance Sale
Delivery. Keep only one version of odoo_advance_sale on a server's addons path.
The original Odoo 19 addon remains unchanged.

See docs/migration.md for compatibility changes and validation results.
