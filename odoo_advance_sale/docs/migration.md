...
- Use tree views and tree action modes, separate access-right/rule checks,
  the Odoo 17 return-wizard method, and storable product test fixtures.
...
- Update the manifest and HTML listing to Odoo 17. Reuse the icon and provide
