...
class StockPicking(models.Model):
    ...
    def action_create_advance_sale(self):
        ...
        # Odoo 18 connects the picking's sale through its procurement group.
        # Give this completed delivery its own group so sibling backorders stay
        # independent and can generate their own sale after validation.
        group = self.env['procurement.group'].create({
            'name': order.name, 'sale_id': order.id,
