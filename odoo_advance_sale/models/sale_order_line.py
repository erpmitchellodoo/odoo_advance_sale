...
class SaleOrderLine(models.Model):
    ...
    _advance_move_unique = models.Constraint(
        'UNIQUE(advance_move_id)', 'A delivery line can only generate one sale line.',
    )

    @api.constrains('advance_move_id', 'order_id', 'product_id', 'product_uom_id', 'product_uom_qty')
